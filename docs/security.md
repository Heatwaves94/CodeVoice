...
- **No hardcoded credentials**: The published package at `@sizachowdhury/codevoice` contains only compiled `dist/` output — no secrets, no dev tokens, no internal tooling.
